...
public class MASAR20080ChangeTest {

	@BeforeAll
	public static void initialize() throws Exception {
		RakurakuCore.initialize("dbunit","MASAR20080Change");
	}

	@BeforeEach
	public void setUp() throws Exception {
		RakurakuCore.setUp("dbunit","MASAR20080Change");
	}
	...
	@Tag("変更98")
	@DisplayName("変更98")
	public void testMASAR20080Change_001() throws Exception {

		RakurakuCore rakurakuCore = new RakurakuCore("/MASAR20080Change/case_001/case_001_", "");// ケース番号の設定
