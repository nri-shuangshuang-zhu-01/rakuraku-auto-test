...
public class MBSCR40030Test {
	...
	public void testMBSCR40030_001() throws Exception {
		...
		/* 操作(バッチ) → 契約取得バッチ */
		rakurakuCore.operateBatch("契約取得バッチ","〇" , "creditManagementDateProcessJob,--operation-date=20211009,--subsidiary-code=JPN,--job-net-id=<jobNetId>,--job-execution-id=<creditManagementDateProcessJob>");
	...
	public void testMBSCR40030_004() throws Exception {
		...
		/* 操作(バッチ) → 契約取得バッチ */
		rakurakuCore.operateBatch("契約取得バッチ","〇" , "creditManagementDateProcessJob,--operation-date=20211010,--subsidiary-code=JPN,--job-net-id=<jobNetId>,--job-execution-id=<creditManagementDateProcessJob>");
	...
	public void testMBSCR40030_005() throws Exception {
		...
		/* 操作(バッチ) → 契約取得バッチ */
		rakurakuCore.operateBatch("契約取得バッチ","〇" , "creditManagementDateProcessJob,--operation-date=,--subsidiary-code=JPN,--job-net-id=<jobNetId>,--job-execution-id=<creditManagementDateProcessJob>");
	...
	public void testMBSCR40030_006() throws Exception {
		...
		RakurakuCore rakurakuCore = new RakurakuCore("/MBSCR40030/case_006/ca006_", "");// ケース番号の設定
		...
		/* 操作(バッチ) → 契約取得バッチ */
		rakurakuCore.operateBatch("契約取得バッチ","〇" , "creditManagementDateProcessJob,--operation-date=,--subsidiary-code=,--job-net-id=<jobNetId>,--job-execution-id=<creditManagementDateProcessJob>");
	...
	public void testMBSCR40030_007() throws Exception {
		...
		/* 操作(バッチ) → 契約取得バッチ */
		rakurakuCore.operateBatch("契約取得バッチ","〇" , "creditManagementDateProcessJob,--subsidiary-code=JPN,--job-net-id=<jobNetId>,--job-execution-id=<creditManagementDateProcessJob>");
	...
	public void testMBSCR40030_008() throws Exception {
		...
		/* 操作(バッチ) → 契約取得バッチ */
		rakurakuCore.operateBatch("契約取得バッチ","〇" , "creditManagementDateProcessJob,--job-net-id=<jobNetId>,--job-execution-id=<creditManagementDateProcessJob>");
