...
public class MBSCR40020Test {
	...
	public void testMBSCR40020_001() throws Exception {
		...
		/* 操作(バッチ) → 契約取得バッチ */
		rakurakuCore.operateBatch("契約取得バッチ","〇" , "soBalanceSummaryJob,--operation-date=20210709,--subsidiary-code=MJP,--job-execution-id=<jobExecutionId>");
	...
	public void testMBSCR40020_008() throws Exception {
		...
		/* 操作(DB準備) → T_SO_BALANCE_SUMMARY → データクリア・挿入 */
		rakurakuCore.operateDBPrepare("T_SO_BALANCE_SUMMARY", "データクリア・挿入", "5");

		/* 操作(DB準備) → T_SO_BALANCE → データクリア・挿入 */
		rakurakuCore.operateDBPrepare("T_SO_BALANCE", "データクリア・挿入", "4");
	...
	@Tag("TEST009")
	@DisplayName("TEST009")
	public void testMBSCR40020_009() throws Exception {

		RakurakuCore rakurakuCore = new RakurakuCore("/MBSCR40020/case_009/case_009_", "");// ケース番号の設定
	...
	@Tag("TEST010")
	@DisplayName("TEST010")
	public void testMBSCR40020_010() throws Exception {

		RakurakuCore rakurakuCore = new RakurakuCore("/MBSCR40020/case_010/case_010_", "");// ケース番号の設定
		...
		/* 操作(DB準備) → T_SO_BALANCE → データクリア・挿入 */
		rakurakuCore.operateDBPrepare("T_SO_BALANCE", "データクリア・挿入", "5");
